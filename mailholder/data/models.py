...
from .utils import (context_field_class,
                                   get_log_level,
                                   get_template_engine,
...
class User(models.Model):
    class Meta:
        app_label = 'data'
        verbose_name = pgettext_lazy("User Name", "User")
        verbose_name_plural = pgettext_lazy("User Names", "Users")

    name = models.CharField(_("Name"), max_length=255)
    email_address = models.EmailField(_("Email"), max_length=255)
...
class Email(models.Model):
    ...
    STATUS_CHOICES = [(STATUS.sent, _("sent")), (STATUS.hold, _("hold")),
                      (STATUS.queued, _("queued"))]

    username = models.ForeignKey(User, blank=True,
                                 null=True, verbose_name=_('User Name'),
    ...
    template = models.ForeignKey('EmailTemplate', blank=True,
...
def get_upload_path(instance, filename):
    ...
    return os.path.join('mailholder_attachments', str(date.year),
...
class Attachment(models.Model):
    ...
    filename = models.CharField(_('Filename'), max_length=255, help_text=_("The original filename"))
